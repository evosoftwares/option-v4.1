# Documentação do Projeto Uber Clone
...
## 📌 Operação do Sistema
- [`OPERACIONAL.md`](OPERACIONAL.md) - Documentação operacional dos fluxos do aplicativo (processos, interações, jornadas, diagramas)
