...
/// Combina apenas a intenção online para calcular o status real
class DriverEffectiveStatus {
  ...
  factory DriverEffectiveStatus.fromJson(Map<String, dynamic> json) {
    return DriverEffectiveStatus(
      ...
      // isWithinWorkingHours is always true now
  ...
  /// Sempre true, já que não estamos mais considerando horários de trabalho
  final bool isWithinWorkingHours;

  /// Status efetivo online (apenas onlineIntent, sem verificar working hours)
  ...
  String get statusDescription {
    ...
    // Removido o check de isWithinWorkingHours
    return 'Online';
  }
