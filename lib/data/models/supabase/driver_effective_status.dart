import '../../../domain/entities/driver_effective_status.dart' as domain;
...
class DriverEffectiveStatus {
  ...
  domain.DriverEffectiveStatus toEntity() => domain.DriverEffectiveStatus(
    driverId: driverId,
    onlineIntent: onlineIntent,
    intentUpdatedAt: intentUpdatedAt,
