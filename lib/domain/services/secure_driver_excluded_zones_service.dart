...
import '../../data/models/supabase/driver_excluded_zone.dart';
...
class SecureDriverExcludedZonesService {
  ...
  Future<DriverExcludedZone> addExcludedZoneWithType({
    ...
    try {
      ...
      // Preparar dados para inserção (usando apenas colunas existentes)
      final zoneData = {
        'driver_id': driverId,
        'neighborhood_name': keyword, // Campo obrigatório - usar keyword como neighborhood_name
        'city': city ?? 'N/A',
        'state': state ?? 'N/A',
        // Removido 'zone_type' e 'keyword' pois não existem na tabela atual
      };
