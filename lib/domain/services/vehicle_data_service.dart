  ...
  List<VehicleModel> _getFallbackModels(int brandId) {
    final fallbackData = {
      ...
      21: [ // Fiat - LÍDER EM COMERCIAIS LEVES
        ...
        const VehicleModel(id: 11, name: 'Uno', code: '11', brandId: 21),
        const VehicleModel(id: 12, name: 'Palio', code: '12', brandId: 21),
        const VehicleModel(id: 13, name: 'Siena', code: '13', brandId: 21),
      ],
      ...
      59: [ // Volkswagen - LÍDER GERAL 16.99% MARKET SHARE
        ...
        const VehicleModel(id: 13, name: 'Up!', code: '13', brandId: 59),
        const VehicleModel(id: 14, name: 'Crossfox', code: '14', brandId: 59),
        const VehicleModel(id: 15, name: 'Spacefox', code: '15', brandId: 59),
      ],
      ...
      23: [ // Chevrolet - 13.37% MARKET SHARE
        ...
        const VehicleModel(id: 11, name: 'Cobalt', code: '11', brandId: 23),
        const VehicleModel(id: 12, name: 'Sonic', code: '12', brandId: 23),
        const VehicleModel(id: 13, name: 'Malibu', code: '13', brandId: 23),
      ],
      ...
      26: [ // Hyundai - 10.17% MARKET SHARE
        ...
        const VehicleModel(id: 11, name: 'Creta SX', code: '11', brandId: 26),
        const VehicleModel(id: 12, name: 'HB20 Active', code: '12', brandId: 26),
      ],
      ...
      14: [ // Jeep - 6.42% MARKET SHARE
        ...
        const VehicleModel(id: 7, name: 'Renegade Sport', code: '7', brandId: 14),
        const VehicleModel(id: 8, name: 'Compass Trailhawk', code: '8', brandId: 14),
      ],
      ...
      22: [ // Ford
        ...
        const VehicleModel(id: 11, name: 'New Fiesta', code: '11', brandId: 22),
        const VehicleModel(id: 12, name: 'Courier', code: '12', brandId: 22),
        const VehicleModel(id: 13, name: 'F-250', code: '13', brandId: 22),
      ],
      ...
      25: [ // Honda
        ...
        const VehicleModel(id: 11, name: 'Legend', code: '11', brandId: 25),
        const VehicleModel(id: 12, name: 'Odyssey', code: '12', brandId: 25),
      ],
      ...
      30: [ // Nissan
        ...
        const VehicleModel(id: 9, name: 'Versa Sedan', code: '9', brandId: 30),
        const VehicleModel(id: 10, name: 'Tiida', code: '10', brandId: 30),
      ],
      ...
      36: [ // Renault  
        ...
        const VehicleModel(id: 9, name: 'Sandero RS', code: '9', brandId: 36),
        const VehicleModel(id: 10, name: 'Duster Oroch', code: '10', brandId: 36),
      ],
      ...
      238: [ // BYD - LÍDER CHINESA 3.1% MARKET SHARE
        ...
        const VehicleModel(id: 8, name: 'e6', code: '8', brandId: 238),
      ],
      ...
      300: [ // GWM - 13ª POSIÇÃO RANKING ANUAL
        ...
        const VehicleModel(id: 5, name: 'Wingle 5', code: '5', brandId: 300),
        const VehicleModel(id: 6, name: 'Haval Jolion', code: '6', brandId: 300),
      ],
      ...
      245: [ // Caoa Chery
        ...
        const VehicleModel(id: 7, name: 'Arrizo 5', code: '7', brandId: 245),
        const VehicleModel(id: 8, name: 'Tiggo 4', code: '8', brandId: 245),
      ],
      ...
      7: [ // BMW
        ...
        const VehicleModel(id: 7, name: 'M3', code: '7', brandId: 7),
        const VehicleModel(id: 8, name: 'Z4', code: '8', brandId: 7),
        const VehicleModel(id: 9, name: 'X6', code: '9', brandId: 7),
      ],
      ...
      18: [ // Mercedes-Benz
        ...
        const VehicleModel(id: 6, name: 'Classe E', code: '6', brandId: 18),
        const VehicleModel(id: 7, name: 'Classe S', code: '7', brandId: 18),
        const VehicleModel(id: 8, name: 'GLE', code: '8', brandId: 18),
        const VehicleModel(id: 9, name: 'GLS', code: '9', brandId: 18),
      ],
      ...
      6: [ // Audi
        ...
        const VehicleModel(id: 6, name: 'A6', code: '6', brandId: 6),
        const VehicleModel(id: 7, name: 'A8', code: '7', brandId: 6),
        const VehicleModel(id: 8, name: 'Q8', code: '8', brandId: 6),
        const VehicleModel(id: 9, name: 'TT', code: '9', brandId: 6),
      ],
