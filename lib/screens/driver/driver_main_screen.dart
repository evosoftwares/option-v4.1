...
class DriverMainScreen extends StatefulWidget {
  /// Creates a new instance of [DriverMainScreen]
...
class _DriverMainScreenState extends State<DriverMainScreen>
  ...
  Widget _buildBottomSheet(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      curve: Curves.easeInOut,
      height: _isBottomSheetExpanded ? 320 : 180,
      child: Container(
        decoration: BoxDecoration(
              ...
              child: Padding(
                ...
                child: ListenableBuilder(
                  ...
                  builder: (context, _) {
                    ...
                    return Column(
                      children: [
                        // Main row with status and button
                        Row(
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (status.isOnline)
                                    Text(
                                      _statusController.onlineTimeText,
                                  ...
                                  if (status.isOffline)
                                    Text(
                                      'Toque em "IR" para começar a receber corridas',
                                      style: textTheme.bodyMedium?.copyWith(
                                        color: colorScheme.onSurfaceVariant,
                                      ),
                                    ),
                            ...
                            _buildGoButton(status),
                          ],
                        ),
                        
                        if (_isBottomSheetExpanded && status.isOnline) ...[
  ...
  Widget _buildStatsGrid(DriverStatus status) {
    final colorScheme = Theme.of(context).colorScheme;
    final textTheme = Theme.of(context).textTheme;
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: _buildStatItem(
              'Tempo',
              _formatOnlineTime(_statusController.status.onlineTime),
              Icons.access_time,
              colorScheme,
              textTheme,
            ),
