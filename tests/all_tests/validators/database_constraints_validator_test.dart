...
void main() {
  group('DatabaseConstraintsValidator', () {
    ...
    group('validateDriver', () {
      ...
      test('deve falhar com vehicle_category nula', () {
        final invalidData = {
          'user_id': '123e4567-e89b-12d3-a456-426614174000',
          'cnh_number': '12345678901',
          'cnh_expiry_date': DateTime.now().add(const Duration(days: 365)).toIso8601String(),
          ...
          'vehicle_color': 'Branco',
          'vehicle_plate': 'ABC1234',
          'vehicle_category': null, // Categoria nula
        };
        ...
        expect(
          ...
          throwsA(isA<ValidationException>().having(
            (e) => e.message,
            'message',
            contains('vehicle_category é obrigatório'),
          )),
        );
      });
      
      test('deve aceitar qualquer vehicle_category não nula', () {
        final validData = {
          'user_id': '123e4567-e89b-12d3-a456-426614174000',
          'cnh_number': '12345678901',
          'cnh_expiry_date': DateTime.now().add(const Duration(days: 365)).toIso8601String(),
          ...
          'vehicle_color': 'Branco',
          'vehicle_plate': 'ABC1234',
          'vehicle_category': 'freight', // Qualquer categoria agora é válida
        };
        
        expect(
          () => DatabaseConstraintsValidator.validateDriver(validData),
          returnsNormally,
        );
      });
