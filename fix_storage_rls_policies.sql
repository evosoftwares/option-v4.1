...
-- Test query to verify permissions (should work after running this script)
-- This is just a verification query - don't run it in production
-- SELECT 1 FROM storage.objects WHERE bucket_id = 'user-photos' LIMIT 1;