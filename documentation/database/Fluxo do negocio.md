...
7.3. Administração via Dashboard Supabase
A administração da plataforma será feita diretamente através do dashboard nativo do Supabase:

**Gestão de Usuários:**
- Visualizar, aprovar, suspender e reativar contas através do Table Editor
- Queries SQL personalizadas para operações em massa
- Histórico de ações registrado na tabela `activity_logs`

**Configurações Globais:**
- Definir Valor Base por KM e Valor Base por Minuto através de queries SQL diretas
- Definir percentual de comissão da plataforma
- Todas as configurações armazenadas nas tabelas existentes

**Comunicação:**
- Enviar notificações push através de queries SQL e funções
- Segmentação por cidade ou tipo de usuário usando filtros SQL

**Suporte:**
- Visualizar detalhes de viagens através do Table Editor para auxiliar em disputas
- Consultas SQL para análise de dados e resolução de problemas

**Operações Administrativas:**
- Todas as operações realizadas via SQL Editor no dashboard Supabase
- Sem necessidade de interface administrativa customizada
- Acesso direto às tabelas e dados através da interface web nativa