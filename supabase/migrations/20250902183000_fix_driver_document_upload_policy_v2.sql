...
DROP POLICY IF EXISTS "Motoristas podem ler seus documentos" ON storage.objects;

-- Remove a política DELETE antiga, se existir
DROP POLICY IF EXISTS "Motoristas podem deletar seus documentos" ON storage.objects;
...
-- desde que o {driver_id} corresponda a um motorista associado ao usuário autenticado.
CREATE POLICY "Motoristas podem fazer upload de documentos (novo caminho)"
...
CREATE POLICY "Motoristas podem atualizar seus documentos (novo caminho)"
...
CREATE POLICY "Motoristas podem ler seus documentos (novo caminho)"
...
CREATE POLICY "Motoristas podem deletar seus documentos (novo caminho)"
